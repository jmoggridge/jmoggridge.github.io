...
(Under construction)  
  Python implementations of [Bioinformatics Algorithms from Pevzner and Compeau](http://bioinformaticsalgorithms.com/) for their Coursera course and problems on Rosalind.  

  - Hidden Markov Models for Sequence Alignment:  
     + [Viterbi algorithm and outcome likelihood problem](bioinfo_algos_notebooks/HMMs for sequences.html)     
