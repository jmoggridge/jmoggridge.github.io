...
## Work experience
 ...
 - Cook at Union Local 613, Ottawa ON, 2013-15 & 2017-20   
 - Teaching assistant for 2nd year biochemistry with Dr. K. Storey at Carleton University, Fall 2015   
 - Cook at the Manx Pub, Ottawa ON, 2008-2012
...
## About me
  ...
  Currently enrolled in the Master of Bioinformatics program at University of Guelph (2020-2021). Interested in next-generation sequencing and designing algorithms. I enjoy solving bioinformatics coding challenges on [Rosalind](http://rosalind.info/users/jasonmoggridge/) and making dashboards.    
...
#### *Ottawa bike counters dashboard*
   ...
   A dashboard summarizing nearly 10 years of municipal bike counter data from 13 different locations in Ottawa, ON. 
   ...
   I would like to develop a seasonal+trend forecasting model for future years.
...
- _Para*sight*_: a random forest classifier for apicomplexan 18S rRNA sequences. [Article (pdf)](mbinf_works/JMoggridge_parasight_pdf.pdf)
...
#### Other notebooks/tutorials/modules
 ...
 - Create a github website: A short how-to create a website similar to this one  with Rstudio & knitr, and host it on GitHub for free (notes to myself for when I forget again, really). This project was forked from [Florian Privé's repo](https://github.com/privefl/rmarkdown-website-template) & he has an excellent tutorial too.
   - [tutorial notebook](webpage_tutorial/webpage.creating.html) &  [github repository](https://github.com/jmoggridge/jmoggridge.github.io)
