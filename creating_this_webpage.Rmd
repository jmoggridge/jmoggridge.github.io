---
title: "Easy website with Rstudio + Github"
---
<br>
...
# Overview  
***
**If you want to make a "your.name.github.io" website with Rstudio like this one**, then you are in luck. The process is fairly simple (famous last words, I know). It helps if you're familiar with Rstudio's Markdown format used in notebooks a bit; if not, this is a good [walk-through](https://seb951.github.io/rmarkdown_workshop/Rmarkdown/rmarkdown_main.html).  

Rstudio has a great variety of tools to analyse, represent and communicate scientific information; 
I'm hoping to leverage these to produce work that is  informative and aesthetic. I'm already a big fan of working with R notebooks and Jupyter, so this route felt natural.
